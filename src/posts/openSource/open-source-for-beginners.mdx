...
I will guide you to resources you can use as a code newbie who wants to contribute and learn in the process. I will not use complex terms to sound 'fancy', I will make it simple and clear. I got you !! 💕

![Believe in yourself gif](https://media.giphy.com/media/cJfV9CjH393seMpIan/giphy.gif)
...
- Learn how to use Google properly.
  When you are stack when solving an issue, you can google and read through different resources to get solutions. Learning how to use resources like [stack overflow](https://stackoverflow.com/), [developer mozilla](https://developer.mozilla.org/en-US/), and language documentation to solve the problem. Googling is an important skill to learn early in your journey since we can't remember everything about a language. Unless you have a super memory or you are a genius(I wish I was 😁).
...
Open source contribution requires you to know basic git commands and also knowing how to navigate your way on Github. You can check out my post about [Git and Github for beginners](https://dev.to/tracycss/git-and-github-for-beginners-po3), to get the basics.

Resources to learn git include:

- [Basic git commands by Atlassian documentation](https://confluence.atlassian.com/bitbucketserver/basic-git-commands-776639767.html)
- [Git handbook](https://guides.github.com/introduction/git-handbook/)
- [Start using git command lines](https://docs.gitlab.com/ee/gitlab-basics/start-using-git.html)
- [Resources to learning Git](https://try.github.io/)

Learning Github resources

- [Github lab learning](https://lab.github.com/)
- [Github guidelines - Hello world](https://guides.github.com/activities/hello-world/)
...
- [Triage Open Source Issues](https://www.codetriage.com/)
...
<img src="https://i.ibb.co/yBKX640/issue-page.png" alt="issue-page" border="0">
...
<img src="https://i.ibb.co/nLC2Pt6/issue-comment.png" alt="issue-comment" border="0">
...
If you want to see how to clone and to create a branch remotely on your computer check out [my first post](https://dev.to/tracycss/git-and-github-for-beginners-po3). I have created a detailed step to follow from using git to clone the project to create a pull request.
...
<img src="https://i.ibb.co/V2YgYGN/create-a-branch.png" alt="create-a-branch" border="0">
...
<img src="https://i.ibb.co/N7ggq4c/part-1-2.png" alt="part-1-2" border="0">
...
<img src="https://i.ibb.co/0yXHjsK/part-3.png" alt="part-3" border="0">
...
<img src="https://i.ibb.co/C7rjv2S/part-4.png" alt="part-4" border="0">

View the report and edit it to your liking. You can also leave it as it is, it's all up to you.

<img src="https://i.ibb.co/3pbqn6T/part-5.png" alt="part-5" border="0">
...
<img src="https://i.ibb.co/YkC1WcM/proposed-changes.png" alt="proposed-changes" border="0">

- Write a commit message
  Write a commit message and additional information that is descriptive. The maintainers need to know which files you added and some additional info about what you created inside the files. Let's make the life of the maintainers easier even if you are a beginner.😊

<img src="https://i.ibb.co/yVJkymB/commit.png" alt="commit" border="0">
...
<img src="https://i.ibb.co/rFDPVpy/pull-request.png" alt="pull-request" border="0">

#### Congratulations you created your first pull request.

The owner or maintainers will now review your changes and see if they want to merge it into the project. Be proud you have learned something new, you are amazing. Start with these small contributions as you prepare for [Hacktoberfest 2020 ](https://hacktoberfest.digitalocean.com/)which is next month.

![Congratulations gif](https://media.giphy.com/media/26DOoDwdNGKAg6UKI/giphy.gif)

#### Conclusion

This was long, woohoo!!! But I hope you learned something new. If you want a step by step guide to clone the open-source repository on your computer and get a basic git command guide, check out my post on [Git and Github for beginners](https://dev.to/tracycss/git-and-github-for-beginners-po3)
<b>PS:</b> You can apply for the [Outreachy internship remote program](https://www.outreachy.org/apply/). The program is based on contributing to open source projects plus you will have amazing mentors to guide you along the way. All the best in your application.
