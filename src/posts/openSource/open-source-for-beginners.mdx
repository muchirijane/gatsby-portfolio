...
![issue-page](https://i.ibb.co/yBKX640/issue-page.png)
...
![issue-comment](https://i.ibb.co/nLC2Pt6/issue-comment.png)
...
![create-a-branch](https://i.ibb.co/V2YgYGN/create-a-branch.png)
...
![part-1-2](https://i.ibb.co/N7ggq4c/part-1-2.png)
...
![part-3](https://i.ibb.co/0yXHjsK/part-3.png)
...
![commit](https://i.ibb.co/yVJkymB/commit)
...
![pull-request](https://i.ibb.co/rFDPVpy/pull-request.png)
...
PS: You can apply for the ![Outreachy internship remote program](https://www.outreachy.org/apply/). The program is based on contributing to open source projects plus you will have amazing mentors to guide you along the way. All the best in your application.
